...
export async function GET({ locals, url }: RequestEvent) {
    ...
    const backlogs = await BacklogDB.getBacklogs(userInst.id, page, pageSize, artifactType, query);
    const serializedBacklogs = backlogs.map(backlog => backlog.serialize());
